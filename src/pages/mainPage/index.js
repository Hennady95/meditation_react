...
import meditation from '../../source/img/icon/meditation-icon.webp'
import yoga from '../../source/img/icon/yoga-icon.webp'
import sound from '../../source/img/icon/sound-icon.webp'
import practice_img from '../../source/img/background/practice-background.webp'
import musicGirls from '../../source/img/music-girls.webp'
import twisted from '../../source/img/transform-girl_twisted.webp'
import fitness from '../../source/img/transform-girl_fitness.webp'
    ...
    return <div>
      ...
      <div className = "meditation">
        ...
        <div className = "meditation-skills">
            ...
            <SkillCard title = "Quick relextion" text = "It is a long established fact that a reader will be distracted by the readable content of a page when looking at its layout." navigation = "left"/>
            <SkillCard title = "The peace" text = "which of us ever undertakes laborious physical exercise, except to obtain some advantage from it." navigation = "right"/>
        </div>
      </div>
